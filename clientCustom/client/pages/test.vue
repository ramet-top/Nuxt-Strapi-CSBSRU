<template>
  ...
  <div>
        ...
        <div class="col-md-12 text-center">
          <div class="jumbotron">
            ...
            <a
              ...
              class="btn btn-outline-unique waves-effect waves-light"
              rel="nofollow"
            >
              Download
            ...
            <a
              ...
              class="btn btn-unique btn-ptc waves-effect waves-light"
              rel="nofollow"
            >
              Learn more
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          ...
          >
            ...
            <div class="card-body">
              ...
              <a href="#" class="btn btn-info waves-effect waves-light">Read more</a>
            </div>
          </div>
          <!--/.Card-->
        </div>
        ...
        <div class="col-lg-4">
          ...
          <div
            class="card wow fadeIn animated"
            data-wow-delay="0.6s"
            style="visibility: visible; animation-name: fadeIn; animation-delay: 0.6s;"
          >
            <!--Card image-->
            <img
              class="img-fluid"
    ...
    <!-- Classroom and computer information ข้อมูลห้องเรียนและเครื่องคอมพิวเตอร์ -->
    <section class="pt-5 container">
      ...
      <div class="wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
        ...
        <!--Section description-->
        <p class="text-center">
          MDB is world's most popular Material Design framework for building responsive,
        ...
        <div class="col-lg-6 col-md-12 px-4">
          ...
          <div class="row">
            ...
            <div class="col-10">
              ...
              <p
                class="grey-text"
              >Thanks to MDB you can take advantage of all feature of newest Bootstrap 4.</p>
            </div>
          </div>
          <!--/First row-->
    ...
    <section
      id="testimonials"
      class="text-center py-5 wow fadeIn"
      style="background-color: rgb(238, 238, 238); visibility: visible; animation-name: fadeIn;"
    >    
      <!-- Container professors one-->
      <div class="container">
        <!-- Section heading -->
        ...
        >
          ...
          <!--Controls-->
          <a
            class="carousel-item-prev left carousel-control"
          ...
          <a
            class="carousel-item-next right carousel-control"
            href="#carousel-example-1"
            role="button"
            data-slide="next"
          >
      ...
      <!--/Section: More two-->
      <section id="buttons" class="text-center container">
        <!--Section: Cards-->
        <section id="cards" class="text-center">
          <!--Section heading-->
          <!-- <h3 class="section-heading mb-5 h1 mt-0">List of professors</h3>         -->
          <!--Grid row-->
          <div class="row">
            <!--Subheading-->
            <div class="col-md-4">
              ...
              <div class="card card-cascade mb-4">
                ...
                <div class="card-body card-body-cascade text-center">
                  ...
                  <p
                    class="card-text"
                  >Sed ut perspiciatis unde omnis iste natus sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
    ...
    <!-- Download เอกสาร -->    
     <div class="container text-center mt-2 mb-2">
        <button class="btn btn-outline-black" href="#" >
            Download File
       ...
       <table class="table table-striped table-responsive-md btn-table">
        <thead>
          <tr>
            <th><i class="far fa-gem mr-2 grey-text" aria-hidden="true"/>#</th>
            <th><i class="fas fa-book mr-2 grey-text" aria-hidden="true"/>File Name</th>
            <th><i class="fas fa-leaf mr-2 teal-text" aria-hidden="true"/>Status </th>
            <th><i class="fas fa-graduation-cap mr-2 grey-text" aria-hidden="true"/>use often </th>
            <th><i class="fas fa-gift mr-2 grey-text" aria-hidden="true"/>
              Download Now
            </th>
          </tr>
        </thead>
            ...
            <td>Otto</td>
             <td>
              <button type="button" class="btn btn-outline-primary btn-sm m-0 waves-effect">
                <i class="fas fa-cloud-download-alt mr-2"/>Download
                </button>
            </td>
          </tr>
          <tr>
